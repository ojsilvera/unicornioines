...
<body>
    ...
    <header>
        ...
        <h1 class="titulo esp">Listado de Roles</h1>
    </header>
            ...
            <div class="col-lg-12">
                <div class="box box-primary">
                        <div class="box-tools pull-right col-lg-3" style="float:right">
                            <a href="{{route('crear.rol')}}" class="btn btn-block btn-info btn-sm">
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    @foreach($datas as $data)
                                        <tr>
                                           {{-- <td>{{$data->idGenero}}</td> --}}
                                            <td>{{$data->descrpRol}}</td>
                                            <td>
                                                <a href="{{route('editar.rol',['id'=>$data->id])}}" class="btn-accion-tabla tooltipsC" title="Editar esta registro">
                                                   <i >editar</i>
                                                </a>
